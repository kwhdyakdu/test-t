                    ...
                    <div class="product__sidebar">
                        <div class="product__sidebar__view">
                            <div class="section-title">
                                <h5>Kids TV Channels</h5>
                            </div>
                            <ul class="filter__controls">
                                <!-- <li class="active" data-filter="*">Day</li> -->
                                <li data-filter=".week"><a href="/search-kids-Live TV channels-0.php">View All</a></li>
                            </ul>
...
OR cat like \"%$trimmed%\"  
OR cnt like \"%$trimmed%\"
OR lnk1 like \"%$trimmed%\"
OR user like \"%$trimmed%\"
ORDER BY views DESC";
